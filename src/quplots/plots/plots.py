...
class plots:
    ...
    def plot_wf_2d(
        self, elect=None, psi_sq=None, max_r=None, n=None, l=None, m=None, **plot_kwargs
    ):
        fig, ax = plt.subplots()
        package = (
            elect.compute_wavefunction_2D()
            if (elect is not None and isinstance(elect, electron))
            else (psi_sq, max_r, n, l, m)
        )
        ...
        ax.contour(
            ...
            levels=levels,
            cmap=cmap,
            extent=[-package[1], package[1], -package[1], package[1]],
            **plot_kwargs,
        )
    ...
    def plot_wf_3d(self, elect, **kwargs_plot):
        ...
        isosurface_kwargs = {
            k: v for k, v in kwargs_plot.items() if k in isosurface_keys
        }
        layout_kwargs = {
            k: v for k, v in kwargs_plot.items() if k not in isosurface_keys
        }
    ...
    def plot_sp(self, **kwargs):
        ...
        fig.update_layout(
            ...
            **{
                ...
                if k not in ["title", "paper_bgcolor", "scene", "font"]
            },
        )
    ...
    def plot_sp3d(self, **kwargs):
        ...
        fig.update_layout(
            title=layout_kwargs.get(
                "title", "<b>sp<sup>3</sup>d: Trigonal Bipyramidal</b>"
            ),
            paper_bgcolor=layout_kwargs.get("paper_bgcolor", "black"),
            scene=layout_kwargs.get(
                "scene",
    ...
    def plot_sp3d2(self, **kwargs):
        ...
        fig.update_layout(
            title=layout_kwargs.get(
                "title", "<b>sp<sup>3</sup>d<sup>2</sup>: Octahedral</b>"
            ),
            paper_bgcolor=layout_kwargs.get("paper_bgcolor", "black"),
            scene=layout_kwargs.get(
                "scene",
